...
import static com.gluonapplication.GluonApplication.START_PAGE_VIEW;
...
public class DrawerManager {
    ...
    public DrawerManager() {
        ...
        final Item start_pageItem = new ViewItem("Start_Page", MaterialDesignIcon.HOME.graphic(), START_PAGE_VIEW, ViewStackPolicy.SKIP);
        final Item secondaryItem = new ViewItem("Secondary", MaterialDesignIcon.DASHBOARD.graphic(), SECONDARY_VIEW);
        drawer.getItems().addAll(start_pageItem, secondaryItem);
